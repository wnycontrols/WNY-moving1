...
- **Per-employee colors** — each employee is auto-assigned a distinct color; click their initials circle to pick from a 12-color palette or choose any custom color
- **Three availability states**, cycled by clicking, each shown in the employee's color:
  - **Available** (solid colored badge)
  - **Partial** (color-striped badge — e.g. AM or PM only)
  - **Unavailable** (dark badge with colored outline, name struck through)
...
5. Click an employee's initials circle to change their color
6. Click the **×** on a chip to remove an employee and all their marks
